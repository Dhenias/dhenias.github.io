        ...
        _cc(t, [{
            ...
            value: function (t, s, e) {
                this.o.size.pulse && (
                    ...
                    (this.s > this.o.size.max || this.s < this.o.size.min) && (this.d *= -1),
                    this.s = Math.abs(this.s)
                );
                this.x += this.vx;
                this.y += this.vy;
                this.x < 0 ? (this.vx *= -1, this.x += 1) :
                    this.x > s && (this.vx *= -1, this.x -= 1);
                this.y < 0 ? (this.vy *= -1, this.y += 1) :
                ...
                if ("c" === this.h)
                    t.arc(this.x, this.y, r, 0, 6.283185, !1);
    ...
    var h = function () {
        function h(i) {
            ...
            t.addEventListener("resize", function () {
                clearTimeout(e),
                    e = setTimeout(s.resize.bind(s), 150)
            }, !1);
        ...
        _cc(h, [{
            ...
            value: function () {
                ...
                this.c.setAttribute("style",
                    "position:absolute;z-index:-1;top:0;left:0;right:0;bottom:0;-webkit-transform:" + e +
                    ";transform:" + e +
                    ";outline: 1px solid transparent;background-color:rgba(" +
                    this.bc.r + "," + this.bc.g + "," + this.bc.b + ",1);"
                );
            }
        }, {
            key: "init",
